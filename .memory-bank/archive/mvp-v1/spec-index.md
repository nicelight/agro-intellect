...
- [.memory-bank/tech-specs/FT-006-vision-observation-plant-state-trust.md](tech-specs/FT-006-vision-observation-plant-state-trust.md): FT-006 tech spec.
- [.memory-bank/tech-specs/FT-007-hydroponics-advisor-missing-data-policy.md](tech-specs/FT-007-hydroponics-advisor-missing-data-policy.md): FT-007 tech spec.
- [.memory-bank/tech-specs/FT-008-tasks-approvals-follow-up-outcomes.md](tech-specs/FT-008-tasks-approvals-follow-up-outcomes.md): FT-008 tech spec.
...
- [.memory-bank/tech-specs/FT-011-minimal-web-app-pwa-operator-surface.md](tech-specs/FT-011-minimal-web-app-pwa-operator-surface.md): FT-011 tech spec.
...
- [.memory-bank/tech-specs/FT-014-human-approval-action-unlock-semantics.md](tech-specs/FT-014-human-approval-action-unlock-semantics.md): FT-014 tech spec.
...
- `.memory-bank/contracts/vision-observation.md`: candidate for a future shared/provider-level vision contract; not required for FT-006 MVP because the feature-local tech spec plus FT-012/FT-004 contracts cover the current boundary.
- `.memory-bank/contracts/companion-output.md`: candidate; companion output.
- `.memory-bank/contracts/hydroponics-advisor.md`: candidate for a future shared/provider-level advisor contract; not required for FT-007 MVP because the feature-local tech spec plus FT-012/FT-013/FT-008 contracts cover the current boundary.
...
- No current feature-level SDD unknowns remain after FT-011.
- Implementation-specific task order, ORM/Pydantic/class names, fixture names, UI component styling, exact response field ordering, and provider configuration remain task-local unless a future feature or ADR promotes them to spec scope.
...
## Cross-Feature Task Ordering Notes
- FT-004 / FT-012 agent-originated publication should be decomposed in this order: first build FT-004 foundation `BusPublicationService` plus `BusEventEnvelope` validation stub; then build FT-012 `MessageEnvelope` / `AgentRuntimeResult` validation and adapter mapping; then add FT-004/FT-012 integration tests proving agent-originated publishable output flows through FT-012 validation and FT-004 Bus publication.
...
| [FT-006 Vision Observation and Plant State Trust](features/FT-006-vision-observation-plant-state-trust.md) | [EP-002](epics/EP-002-agent-advisory-safety-loop.md) | complete | [FT-006 tech spec](tech-specs/FT-006-vision-observation-plant-state-trust.md), [plant state](states/plant-state.md), [MessageEnvelope](contracts/message-envelope.md), [FT-012 tech spec](tech-specs/FT-012-agent-runtime-decisions-message-envelope-output-contracts.md), [FT-004 tech spec](tech-specs/FT-004-agent-chat-bus-event-stream-publication-boundary.md), [runtime data model](domains/runtime-data-model.md), [photo artifacts](domains/photo-artifacts.md), [FT-002 tech spec](tech-specs/FT-002-photo-intake-catalog-capture-manifests.md), [FT-003 tech spec](tech-specs/FT-003-runtime-state-timeline-audit.md), [dataset governance](states/dataset-governance.md), [FT-009 tech spec](tech-specs/FT-009-dataset-governance-trainability.md), [task follow-up](states/task-follow-up.md), [FT-008 tech spec](tech-specs/FT-008-tasks-approvals-follow-up-outcomes.md), [safety approval](states/safety-approval.md), [FT-013 tech spec](tech-specs/FT-013-safety-gate-physical-action-advice.md), [API guidelines](contracts/api-guidelines.md), [first demo](testing/first-demo.md), [invariants](invariants.md) | Feature-local design resolves Vision Observation report shape, observation-vs-diagnosis boundary, source refs, confidence/status mapping, plant-state promotion gates, contradictory observations, MessageEnvelope claim routes, dataset handoff, API/service surface, and verification targets without a broad provider abstraction. |
| [FT-007 Hydroponics Advisor and Missing Data Policy](features/FT-007-hydroponics-advisor-missing-data-policy.md) | [EP-002](epics/EP-002-agent-advisory-safety-loop.md) | complete | [FT-007 tech spec](tech-specs/FT-007-hydroponics-advisor-missing-data-policy.md), [FT-001 tech spec](tech-specs/FT-001-daily-check-in-observations-manual-measurements.md), [MessageEnvelope](contracts/message-envelope.md), [FT-012 tech spec](tech-specs/FT-012-agent-runtime-decisions-message-envelope-output-contracts.md), [safety approval](states/safety-approval.md), [FT-013 tech spec](tech-specs/FT-013-safety-gate-physical-action-advice.md), [task follow-up](states/task-follow-up.md), [FT-008 tech spec](tech-specs/FT-008-tasks-approvals-follow-up-outcomes.md), [FT-014 tech spec](tech-specs/FT-014-human-approval-action-unlock-semantics.md), [runtime data model](domains/runtime-data-model.md), [system architecture](architecture/system-architecture.md), [API guidelines](contracts/api-guidelines.md), [first demo](testing/first-demo.md), [invariants](invariants.md) | Feature-local design resolves advisor input refs, missing/stale pH/EC policy, clarification-vs-task handoff, cautious recommendation wording, MessageEnvelope claim routes, Safety Gate handoff, no direct action-task creation, API/service surface, and verification targets. |
| [FT-008 Tasks, Approvals, and Follow-up Outcomes](features/FT-008-tasks-approvals-follow-up-outcomes.md) | [EP-002](epics/EP-002-agent-advisory-safety-loop.md) | complete | [FT-008 tech spec](tech-specs/FT-008-tasks-approvals-follow-up-outcomes.md), [task follow-up](states/task-follow-up.md), [safety approval](states/safety-approval.md), [runtime data model](domains/runtime-data-model.md), [timeline event](contracts/timeline-event.md), [FT-003 tech spec](tech-specs/FT-003-runtime-state-timeline-audit.md), [FT-001 tech spec](tech-specs/FT-001-daily-check-in-observations-manual-measurements.md), [FT-013 tech spec](tech-specs/FT-013-safety-gate-physical-action-advice.md), [FT-014 tech spec](tech-specs/FT-014-human-approval-action-unlock-semantics.md), [MessageEnvelope](contracts/message-envelope.md), [API guidelines](contracts/api-guidelines.md), [first demo](testing/first-demo.md), [invariants](invariants.md) | Feature-local design resolves task boundaries/statuses, creation sources, FT-014 unlock coordination, due/follow-up timing, outcome capture, event/audit refs, API/service surface, and verification targets. |
...
| [FT-011 Minimal Web App/PWA Operator Surface](features/FT-011-minimal-web-app-pwa-operator-surface.md) | [EP-004](epics/EP-004-local-operations-operator-ui.md) | complete | [FT-011 tech spec](tech-specs/FT-011-minimal-web-app-pwa-operator-surface.md), [system architecture](architecture/system-architecture.md), [API guidelines](contracts/api-guidelines.md), [UI Feed](contracts/ui-feed.md), [FT-005 tech spec](tech-specs/FT-005-ui-feed-context-hygiene.md), [local security](runbooks/local-security.md), [FT-010 tech spec](tech-specs/FT-010-local-security-privacy-lazy-sync.md), [safety approval](states/safety-approval.md), [FT-013 tech spec](tech-specs/FT-013-safety-gate-physical-action-advice.md), [FT-014 tech spec](tech-specs/FT-014-human-approval-action-unlock-semantics.md), [FT-001 tech spec](tech-specs/FT-001-daily-check-in-observations-manual-measurements.md), [FT-002 tech spec](tech-specs/FT-002-photo-intake-catalog-capture-manifests.md), [FT-003 tech spec](tech-specs/FT-003-runtime-state-timeline-audit.md), [FT-006 tech spec](tech-specs/FT-006-vision-observation-plant-state-trust.md), [FT-007 tech spec](tech-specs/FT-007-hydroponics-advisor-missing-data-policy.md), [FT-008 tech spec](tech-specs/FT-008-tasks-approvals-follow-up-outcomes.md), [FT-012 tech spec](tech-specs/FT-012-agent-runtime-decisions-message-envelope-output-contracts.md), [first demo](testing/first-demo.md), [invariants](invariants.md) | Feature-local design resolves minimal routes/views, daily operator workflow, chat/check-in/photo/pH/EC/task/history/recommendation/approval/sync prompt surfaces, UI Feed presentation-only consumption, safety display checks, local auth/LAN behavior, PWA/offline boundaries, API dependency map, and UI/e2e targets. |
...
| [FT-014 Human Approval and Action Unlock Semantics](features/FT-014-human-approval-action-unlock-semantics.md) | [EP-002](epics/EP-002-agent-advisory-safety-loop.md) | complete | [FT-014 tech spec](tech-specs/FT-014-human-approval-action-unlock-semantics.md), [safety approval](states/safety-approval.md), [task follow-up](states/task-follow-up.md), [runtime data model](domains/runtime-data-model.md), [timeline event](contracts/timeline-event.md), [FT-003 tech spec](tech-specs/FT-003-runtime-state-timeline-audit.md), [FT-013 tech spec](tech-specs/FT-013-safety-gate-physical-action-advice.md), [API guidelines](contracts/api-guidelines.md), [first demo](testing/first-demo.md), [invariants](invariants.md) | Feature-local design resolves approval/rejection record shape, pending proposal representation, stale/replay prevention, human-performed action unlock service, event/audit refs, API surface, and no-device-execution verification targets. |
...
- FT-006 has completed feature-local `/spec-improve`; no FT-006 blocker remains for `/prd-to-tasks FT-006`.
- FT-007 has completed feature-local `/spec-improve`; no FT-007 blocker remains for `/prd-to-tasks FT-007`.
- FT-008 has completed feature-local `/spec-improve`; no FT-008 blocker remains for `/prd-to-tasks FT-008`.
...
- FT-011 has completed feature-local `/spec-improve`; no FT-011 blocker remains for `/prd-to-tasks FT-011`.
