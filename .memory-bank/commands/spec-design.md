...
- `.memory-bank/spec-index.md`
- `.memory-bank/architecture/system-architecture.md` with Mermaid C4/context/container/component, authority model, module boundaries, runtime/external boundaries, data flow, and sequence diagrams when useful
