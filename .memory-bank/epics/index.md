...
- [EP-003 Agent Runtime And Context Hygiene](EP-003-agent-runtime-context-hygiene.md): planned overall; FT-008 Bus/UI persistence, publication, protected feed, and context isolation are verified, while live-provider UAT, Vision/Plant trust, and Hydroponics Advisor outcomes remain downstream.
