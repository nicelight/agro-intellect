...
Run global `/spec-design` before this feature is task-decomposed. Then run `/spec-improve FT-004` to define exact daily check-in state, fields, persistence sequence, freshness projections, and API/UI dependencies before `/prd-to-tasks FT-004`.
