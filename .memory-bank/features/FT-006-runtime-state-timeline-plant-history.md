...
Run global `/spec-design` before this feature is task-decomposed. Then run `/spec-improve FT-006` to define exact runtime state ownership, timeline event taxonomy, history projections, export refs, and retention behavior before `/prd-to-tasks FT-006`.
