...
Run global `/spec-design` before this feature is task-decomposed. Then run `/spec-improve FT-014` to define exact dataset fields, lifecycle, transition authority, evidence refs, trainability recomputation, and tests before `/prd-to-tasks FT-014`.
