...
The backend MUST bind to loopback by default; LAN mode requires explicit enablement and authentication/token protection. CORS, upload validation, path safety, path traversal rejection, and secret redaction are required. Local plant photos/manifests MUST remain private by default. MVP sync status MUST support `local_only`; the 200 MB upload prompt MUST NOT imply a server or change sync status.
...
## Traceability (RTM)
When one requirement spans multiple feature boundaries, the RTM lists the relevant EP/FT links in the same cell instead of splitting the REQ without PRD need.

| REQ | Epic | Feature | Test | Lifecycle |
|---|---|---|---|---|
| REQ-001 | [EP-001](epics/EP-001-evidence-intake-runtime-authority.md) | [FT-001](features/FT-001-daily-check-in-observations-manual-measurements.md) | workflow:daily-check-in-smoke; integration:observation-state-events | planned |
| REQ-002 | [EP-001](epics/EP-001-evidence-intake-runtime-authority.md) | [FT-002](features/FT-002-photo-intake-catalog-capture-manifests.md) | schema:photo-catalog; integration:photo-upload; policy:photo-required-plant-id | planned |
| REQ-003 | [EP-001](epics/EP-001-evidence-intake-runtime-authority.md) | [FT-002](features/FT-002-photo-intake-catalog-capture-manifests.md) | schema:photo-manifest; integration:initial-vs-export-manifest; policy:no-runtime-read-from-stale-manifest | planned |
| REQ-004 | [EP-001](epics/EP-001-evidence-intake-runtime-authority.md)<br>[EP-002](epics/EP-002-agent-advisory-safety-loop.md) | [FT-001](features/FT-001-daily-check-in-observations-manual-measurements.md)<br>[FT-007](features/FT-007-hydroponics-advisor-missing-data-policy.md)<br>[FT-008](features/FT-008-tasks-approvals-follow-up-outcomes.md)<br>[FT-013](features/FT-013-safety-gate-physical-action-advice.md) | policy:ph-ec-freshness; workflow:missing-or-stale-measurement-task; policy:safety-gate-physical-actions | planned |
...
| REQ-007 | [EP-002](epics/EP-002-agent-advisory-safety-loop.md) | [FT-005](features/FT-005-ui-feed-context-hygiene.md)<br>[FT-012](features/FT-012-agent-runtime-decisions-message-envelope-output-contracts.md) | schema:ui-feed-event; policy:context-filtering; policy:concise-output | planned |
| REQ-008 | [EP-002](epics/EP-002-agent-advisory-safety-loop.md) | [FT-006](features/FT-006-vision-observation-plant-state-trust.md) | workflow:vision-to-plant-state; policy:agent-hypothesis-not-confirmed | planned |
| REQ-009 | [EP-002](epics/EP-002-agent-advisory-safety-loop.md) | [FT-007](features/FT-007-hydroponics-advisor-missing-data-policy.md)<br>[FT-013](features/FT-013-safety-gate-physical-action-advice.md)<br>[FT-014](features/FT-014-human-approval-action-unlock-semantics.md) | policy:safety-gate-physical-actions; policy:user-visible-action-advice-fail-closed; workflow:approval-prompt-human-action | planned |
| REQ-010 | [EP-002](epics/EP-002-agent-advisory-safety-loop.md) | [FT-008](features/FT-008-tasks-approvals-follow-up-outcomes.md)<br>[FT-014](features/FT-014-human-approval-action-unlock-semantics.md) | workflow:task-follow-up-outcome; integration:approved-action-task-transition | planned |
| REQ-011 | [EP-003](epics/EP-003-learning-governance.md) | [FT-009](features/FT-009-dataset-governance-trainability.md) | policy:dataset-trainability; policy:split-restrictions; schema:dataset-provenance | planned |
| REQ-012 | [EP-004](epics/EP-004-local-operations-operator-ui.md) | [FT-010](features/FT-010-local-security-privacy-lazy-sync.md) | security:local-backend-baseline; security:cors-allowlist; security:upload-validation; security:secret-redaction-logs-timeline-manifests-ui-agent-chat-bus-screenshots; policy:private-artifact-approval-sync-privacy; policy:lazy-sync-local-only | planned |
| REQ-013 | [EP-004](epics/EP-004-local-operations-operator-ui.md) | [FT-011](features/FT-011-minimal-web-app-pwa-operator-surface.md) | e2e:daily-ui-smoke; integration:ui-feed-presentation; policy:user-visible-action-advice-fail-closed | planned |
