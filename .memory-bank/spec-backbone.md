...
| open_questions | authoritative | [.memory-bank/spec-backbone.md](spec-backbone.md), [.memory-bank/architecture/system-architecture.md](architecture/system-architecture.md), [.memory-bank/foundation.md](foundation.md) | No global blocker; feature concerns route through canonical subject specs. |
...
- Notes: All relevant global/shared areas have authoritative routes. Detailed feature concerns are discovered, reused, extended, or created at canonical subject paths and composed by features/tasks.
