...
- Notes: /spec-init completed. Active PRD has enough actor, scenario, domain, constraint, non-goal, boundary, lifecycle, and risk evidence for /prd decomposition. Global architecture/backbone design was completed by /spec-design on 2026-06-14 and refreshed for compact Foundation Dev Path routing on 2026-06-23; see Global Backbone Status.
...
- Completed: yes, on 2026-06-14; refreshed on 2026-06-23 for compact Foundation Dev Path routing.
...
- Stop conditions: PRD scope changes; a feature requires a global/shared decision not covered here; concrete feature design cannot truthfully define auth/session, route schemas, DB migrations, state machines, event payloads, freshness/action policy, provider configuration, or UI routes.
