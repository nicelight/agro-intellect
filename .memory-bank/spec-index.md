...
| Foundation Dev Path | foundation_decision | [.memory-bank/foundation.md](foundation.md) | active | /spec-design | Required compact FT-000 executable baseline decision for task schema/protocol alignment, backend scaffold anchors, Windows local bootstrap, PostgreSQL init, migrations, local runtime roots, and redaction baseline before product feature tasking. |
