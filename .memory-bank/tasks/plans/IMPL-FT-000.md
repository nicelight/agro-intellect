...
current task-record protocol, backend scaffold anchors, Windows 10 local
...
|---|---|---|---|
| `TASK-000-FT-000-W-0` | T1 | ready | Align task schema/protocol evidence and backend scaffold/package anchors. |
| `TASK-001-FT-000-W-0` | T2 | planned | Implement Windows local bootstrap and local runtime configuration roots. |
| `TASK-002-FT-000-W-0` | T2 | planned | Implement local PostgreSQL init, Alembic migration, and DB readiness baseline. |
| `TASK-003-FT-000-W-0` | T3 | planned | Implement secret redaction baseline for bootstrap, settings, errors, and evidence. |
| `TASK-004-FT-000-W-0` | T2 | planned | Run final Foundation gate and record build/start/bootstrap/db/migration/test evidence. |
...
later must depend directly or transitively on `TASK-004-FT-000-W-0`.
